            ...
            <div id="carouselExampleControls" className="carousel slide carousel-fade" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active" data-bs-interval="500">
                        <img src="https://www.garena.vn/img/top-carousel-aov.32f1caee.jpg" className="d-block w-100" alt="..." />
                    </div>
                    <div className="carousel-item" data-bs-interval="500">
                        <img src="https://www.garena.vn/img/top-carousel-bns.98d7d284.jpg" className="d-block w-100" alt="..." />
                    </div>
                    <div className="carousel-item" data-bs-interval="500">
                        <img src="https://www.garena.vn/img/top-carousel-fo4.7747588a.jpg" className="d-block w-100" alt="..." />
                    </div>
                </div>
