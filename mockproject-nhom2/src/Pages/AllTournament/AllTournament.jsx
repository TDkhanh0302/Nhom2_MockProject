            ...
            <div id="carouselExampleControls" className="carousel slide carousel-fade" data-bs-ride="carousel">
                <div className="carousel-inner">
                    ...
                    <div className="carousel-item" data-bs-interval="500">
                        <img src="https://www.garena.vn/img/top-carousel-ff.6f3ea9e5.jpg" className="d-block w-100" alt="..." />
                    </div>
                    <div className="carousel-item" data-bs-interval="500">
                        <img src="https://www.garena.vn/img/top-carousel-lol.60e16cea.jpg" className="d-block w-100" alt="..." />
                    </div>
                </div>
